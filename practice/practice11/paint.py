...
TOOL_LABELS = {
    ...
    TOOL_SQUARE:    "Square",
    TOOL_CIRCLE:    "Circle",
    TOOL_RTRIANGLE: "Right Triangle",
    TOOL_EQTRIANGLE:"Equilateral Triangle",
    TOOL_RHOMBUS:   "Rhombus",
    TOOL_FILL:      "Fill",
    TOOL_ERASER:    "Eraser",
}
...
class Toolbar:
    ...
    def __init__(self, font, small_font):
        ...
        self.clear_rect = pygame.Rect(10, self.palette_bottom - self.SEC_GAP - 20 , TOOLBAR_W - 20, 32)
    ...
    def draw(self, surface, active_tool, active_colour, active_size):
        ...
        # Заголовок палитры
        ph = self.small_font.render("COLOR", True, TEXT_COLOUR)
        ...
        ct = self.small_font.render("CLEAR", True, BLACK)
