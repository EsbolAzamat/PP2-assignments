...
class RacerGame:
    ...
    def _draw_hud(self):
        ...
        espd_txt  = self.font.render(f"Enemies: {self.enemy_speed:.1f} px/s", True, (255, 100, 100))
        pspd_txt  = self.font.render(f"Player : {self.player.speed:.1f} px/s", True, (100, 200, 255)) 
