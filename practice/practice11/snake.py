...
FOOD_TYPES = [
    {"label": "Apple",  "value": 1, "colour": RED,    "weight": 50, "lifetime": None },  # Бессмертное
    {"label": "Orange", "value": 2, "colour": ORANGE, "weight": 30, "lifetime": 50   },  # ~5 сек при FPS 10
    {"label": "Grapes", "value": 3, "colour": PURPLE, "weight": 15, "lifetime": 30   },  # ~3 сек
    {"label": "Star",   "value": 5, "colour": YELLOW, "weight": 5,  "lifetime": 20   },  # ~2 сек (редкая!)
]
...
class SnakeGame:
    ...
    def _draw_hud(self):
        ...
        ctrl_txt   = self.small_font.render("Arrows/WASD = move  |  R = restart  |  ESC = exit", True, SILVER)
    ...
    def _draw_game_over(self):
        ...
        rst  = self.font.render("Press R to restart  |  ESC to exit", True, WHITE)
